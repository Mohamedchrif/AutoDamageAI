                    ...
                    <div id="profile-edit" style="display: none; animation: fadeIn 0.3s ease;">
                        ...
                        <form action="profile.php" method="POST">
                            ...
                            <div class="edit-actions">
                                <button type="submit" class="submit-btn" style="width: auto; padding: 0.8rem 2.5rem; border-radius: 0.75rem; font-size: 0.95rem; display: flex; align-items: center; gap: 0.6rem;">
